...
function createClient(options) {
  const {
    ...
    retryWait = async function randomisedExponentialBackoff(retries2) {
      ...
      await new Promise((resolve4) => setTimeout(resolve4, retryDelay + // add random timeout from 300ms to 3s
    ...
    iterate(request) {
      ...
      const iterator = function iterator2() {
        return __asyncGenerator(this, arguments, function* iterator_1() {
          for (; ; ) {
            if (!pending.length) {
              yield __await(new Promise((resolve4) => deferred.resolve = resolve4));
            }
...
function subscribeImpl(args) {
  ...
  return sourcePromise.then(function(resultOrStream) {
    return (
      ...
      isAsyncIterable2(resultOrStream) ? mapAsyncIterator(resultOrStream, mapSourceToResponse, reportGraphQLError) : resultOrStream
    );
  });
}
...
//# sourceMappingURL=chunk-KEM65MS3.js.map
