var E=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')});import We from"express";import{DevtoolsEvent as v,receive as _,send as P}from"@refinedev/devtools-shared";import me from"express";import x from"path";var w=e=>{e.use(me.static(x.join(__dirname,"client"))),e.use((t,r,o)=>{if(t.path.startsWith("/api")||t.path.startsWith("/open-in-editor"))return o();r.status(200).sendFile(x.join(`${__dirname}/client/index.html`))})};import ge from"ws";import fe from"dotenv";var D={};fe.config({processEnv:D});var ue=process.env.REFINE_DEVTOOLS_PORT||D.REFINE_DEVTOOLS_PORT,ve=5001,h=Number(ue)||ve,L="https://auth.refine.dev",C="https://cloud2.refine.dev",j="/api/login",A="/api/login-callback",N="/after-login",V="https://raw.githubusercontent.com/refinedev/refine/main/packages/devtools-server/FEED.md";import{bold as U,cyanBright as F}from"chalk";var $=(e,t)=>{let r=new ge.Server({server:e}).on("error",o=>{(o==null?void 0:o.code)==="EADDRINUSE"?console.error(`
${F.bold("\u2717 ")}${U("Refine Devtools server")} (websocket) failed to start. Port ${h} is already in use.
`):console.error(`
${F.bold("\u2717 ")}${U("error from refine devtools")}`,o),r.close(()=>{}),t()});return r.on("connection",o=>{o.on("close",()=>{o.terminate()})}),process.on("SIGTERM",()=>{r.close(()=>{})}),r};import"lodash-es/debounce.js";import"@refinedev/devtools-shared";import"ws";var H=()=>0;import{bold as T,cyanBright as y}from"chalk";import Pe from"http";var M=(e,t)=>{let r=Pe.createServer(e);return r.on("error",o=>{(o==null?void 0:o.code)==="EADDRINUSE"?(console.error(`
...
`)}),process.on("SIGTERM",()=>{r.close(()=>{})}),r.listen(h,void 0,void 0,()=>{}),r};var he={connectedApp:null,clientWs:null,devtoolsWsClients:[],appWsClients:[],activities:[],packages:[]},G=()=>({...he});import{json as Ue}from"express";import Fe from"lodash-es/uniq.js";import _e from"node-fetch";import Re from"gray-matter";import{marked as b}from"marked";import S from"sanitize-html";var ye=e=>e.split("---section").slice(1).map(r=>`---section${r}`),Ee=e=>{let t=new b.Renderer;t.link=function(...o){return b.Renderer.prototype.link.apply(this,o).replace(/^<a/,'<a target="_blank" rel="noopener noreferrer"')};let r=b(e,{renderer:t});return S(r,{allowedTags:S.defaults.allowedTags.concat(["img"]),allowedAttributes:{...S.defaults.allowedAttributes,img:["src"]}})},Ae=e=>{let t=Re(e.replace("---section","---"));return{...t.data,content:Ee(t.content)}},Te=async()=>{try{return(await _e(V)).text()}catch{return""}},q=async()=>{try{let e=await Te();return ye(e).map(Ae)}catch{return[]}};import Le from"fs";import Ie from"path";import Oe from"globby";var W=async e=>{try{let t=await Oe(`node_modules/${e}/package.json`,{onlyFiles:!0}),r=null;try{let o=E.resolve(Ie.join(e,"package.json"));o&&(r=o)}catch{}return[...t,...r?[r]:[]][0]??null}catch{return null}};var J=async e=>{try{let t=await W(e);if(!t)return null;let r=JSON.parse(Le.readFileSync(t,{encoding:"utf-8"}));return{name:r.name,version:r.version,description:r.description}}catch{return null}};import be from"path";import{readJSON as Se}from"fs-extra";var I=async(e=process.cwd())=>{let t=await Se(be.join(e,"package.json"),{encoding:"utf-8"});return Object.keys(t.dependencies).filter(o=>o.startsWith("@refinedev/"))};var B=e=>e.replace("@refinedev/","https://c.refine.dev/");var K=e=>"https://refine.dev/docs/api-reference/general-concepts/";var Y=async e=>{try{let t=await I(e);return await Promise.all(t.map(async o=>{let l=await J(o);return{name:o,currentVersion:l==null?void 0:l.version,description:l==null?void 0:l.description,changelog:B(o),documentation:K(o)}}))}catch{return[]}};import d from"dedent";var ke=[{name:"@refinedev/ably",description:"Ably integration for Refine",install:"npm install @refinedev/ably",usage:d(`
